...
public class RemoteEventListener implements Listener {
	private final SQNetEvents netEvents;
	private final PermissionManager manager;

	public RemoteEventListener(SQNetEvents netEvents, PermissionManager manager) {
		this.netEvents = netEvents;
		this.manager = manager;
	}

	public boolean isLocal(PermissionEvent event) {
		return netEvents == null || event.getSourceUUID().equals(netEvents.getUUID());
	}
