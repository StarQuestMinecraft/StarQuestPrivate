...
public class MapUpdateCommand {
	...
	Block block;
	private net.minecraft.server.v1_8_R2.Chunk chunk = null;
	...
	public void setChunk(net.minecraft.server.v1_8_R2.Chunk chunk){
		this.chunk = chunk;
	}
	public net.minecraft.server.v1_8_R2.Chunk getChunk(){
		return chunk;
	}
